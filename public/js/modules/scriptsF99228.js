...
{
	var formF99228 = $('.add-f99228');
	formF99228.on('submit', function()
	{
		$.ajax({
			type: formF99228.attr('method'),
			url: formF99228.attr('action'),
			data: formF99228.serialize(),
...
function ListF99228()
{
	var divF99228 = $('#listF99228');
	var spanTotal = $('#total');
	var route = 'http://notes.dev/islr99228';
	$('#listF99228').empty();
	$('#total').empty();
