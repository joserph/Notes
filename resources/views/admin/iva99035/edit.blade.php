...
{!! Form::label('periodo', 'Periodo') !!}
 	<div class="row">
 		<div class="col-md-6">
 			<input type="text" name="periodo" class="form-control" placeholder="mm-yyyy" id="periodoEdit">
 		</div>
 	</div>
...
<br>	
<button tipe="submit" class="btn btn-warning" id="edit-f99035"><i class="fa fa-refresh"></i> Actualizar</button>