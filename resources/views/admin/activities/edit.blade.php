...
<div class="row">
	<div class="col-md-6">
		{!! Form::select('tipo', [
            'fija' => 'Fija',
            'temporal' => 'Temporal'], null, ['class' => 'form-control', 'id' => 'tipoEdit', 'placeholder' => 'Seleccionar tipo de actividad']) !!}
	</div>
</div>
...
<br>	
<button tipe="submit" class="btn btn-warning" id="edit-activity"><i class="fa fa-refresh"></i> Actualizar</button>
